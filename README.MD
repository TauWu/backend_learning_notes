...
- [ ] 高级语言学习
    - [ ] Python学习
        ...
        - [ ] [Python基础知识](https://github.com/TauWu/review_note/tree/master/高级语言学习/Python学习/Python基础知识)
    - [ ] Golang学习
    - [ ] Java学习
...
- [ ] 计算机基础
    ...
    - [ ] 数据结构
        ...
        - [ ] [图](https://github.com/TauWu/review_note/tree/master/计算机基础/数据结构/笔记/图.md)
        - [ ] 内部排序算法 
    - [x] 操作系统
